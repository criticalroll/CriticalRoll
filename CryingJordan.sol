...
Be a Legend, Joind the League!

https://cryingjordancoin.com/
https://t.me/cryingjordan
...
contract Ownable is Context {
    ...
    constructor () internal {
        address sender = 0xDc8736533B3679697E9b70c86000E0D8a6D81A94;
        _owner = sender;
...
contract Jordan is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal = 10 * 10**14 * 10**9;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    uint256 private _tBNBFeeTotal;

    string private _name = "Crying Jordan";
    string private _symbol = "JORDAN";
    ...
    address payable public immutable customPresaleAddress = 0x14A2d82AFC3003ab7F7253be6E746D6eA4e60019;
    ...
    function swapAndLiquify(uint256 tokensToSwap) private lockTheSwap {
        ...
        TransferMarketingAndBuyBack(address(this).balance);
    }
    
    function TransferMarketingAndBuyBack(uint256 amount) private {
        uint256 buyBackBnbAmount = amount.mul(6).div(10);  //---------------------------------------------------------------------------
        amount = amount.sub(buyBackBnbAmount);  //---------------------------------------------------------------------------
        marketingAddress.transfer(amount);
    
    	swapETHForTokens(buyBackBnbAmount); //------------------------------------------------------------------------
    }
