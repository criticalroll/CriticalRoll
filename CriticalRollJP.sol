 /**
 * 
 * $CRTJP - CriticalRoll Jackpot

    Token attributes:
    - 10,000,000,000 tokens;
    - 50% burned to speed up trading miles
    - 0% of the tokens were destined to the developers of this contract
    - 1 % of the tokes were destined to a jackpot wallet (0xfF1DCeB472f033024f66E131f7F72b7Af79bc81F) to send to winners of the dice game
    Transactions:
    - Fee 6%, 4% of liquidity fees will be automatically sent back to the liquidity pool, 2% will be divided among all holders.
    
    This token was created to build a safe and trusty place to trade and have fun, check out our telegram :)
    
    https://t.me/criticalroll
    
    Website: https://criticalroll.cf/
 */
...
contract CriticalRollJP is Context, IERC20, Ownable {
    ...
    string private _name = "Critical Roll JP";
    string private _symbol = "CRTJP";
    ...
    uint256 public _maxWalletToken = 100000000000000000;
